...
FareWeave 0.2.0 first queries **Skiplagged, Ryanair, Vueling, and easyJet**. If those results are insufficient, it continues with **Transavia, Norwegian, Air France/KLM, and Wizz Air**.
...
Google Flights is also included as a manual cross-check. In FareWeave 0.2.0 it is **not a separate automated Google Flights provider**, but a suitable search link for the requested route and travel dates.
